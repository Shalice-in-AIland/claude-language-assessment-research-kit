# Using CLAS in your own project — setup and session habits

*CLAS is a toolkit you point at **your** research project; this page is how to wire it in once, and the two habits that keep public tools and private research cleanly apart. Every step that needs no clicks from you is one sentence — ask Claude and it happens.*
...
## One-time: get CLAS onto your computer
...
1. **Sibling folder (recommended)** — keep `claude-language-assessment-skills/` next to your project folder and invoke skills by path: *"Read ../claude-language-assessment-skills/skills/zotero-citations/SKILL.md and set up automatic citations for me."* One CLAS copy serves every project, and updates land once.
...
Everything the skills create — conventions, matrices, notes, digests, review files — lives in **your project**, not in CLAS.

## The two session habits (they matter more than they look)

1. **One Claude Code session per project, opened at that project's folder.** Claude loads the folder's own `CLAUDE.md`, conventions, and permissions — your assessment project's context, not another project's. Keep a separate session for the CLAS folder itself only if you're modifying CLAS.
2. **Public and private stay structurally apart.** CLAS is public-facing; your manuscripts, review matrices, and (above all) anything you review *for a journal* are not. Working in per-project sessions makes that boundary structural rather than something to remember: nothing from your research folders can drift into a repo you might push, and the skills' confidential outputs (notes, plans) stay beside the manuscripts they quote. A one-page `CLAUDE.md` in your project folder (ask Claude to draft one) tells every future session what the project is and where its rules live.

## Updating CLAS later

Ask Claude, in your CLAS-folder session: *"check for and fetch the latest CLAS."* Your projects don't change — conventions files and matrices are yours; only the toolkit refreshes.
