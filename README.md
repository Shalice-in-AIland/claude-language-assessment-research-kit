...
| [`model-radar`](skills/model-radar/SKILL.md) | Maintenance watch on the AI models your audits pin — monthly liveness check of pinned model IDs (aliases retire quietly), vendor prompting-guide deltas, price/tier changes; propose-only log | [docs/07](docs/07-literature-review.md#the-audit-highly-recommended-before-submission-milestones) |
