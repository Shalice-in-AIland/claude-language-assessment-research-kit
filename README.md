...
| [`literature-radar`](skills/literature-radar/SKILL.md) | Standing watch for new papers — scheduled sweeps, strict dedup against your corpus, pre-screened triage-ready digests with a "needs your attention" shortlist; discovery only, you approve inclusions | [docs/07](docs/07-literature-review.md) | — |
